            ...
            <div className="space-y-3 pt-2">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="text-xs font-bold">Stripe Instant Checkout</p>
                    <p className="text-[10px] text-slate-400 font-normal">
              ...
              <Link
                href={`/invoice?plan=qr_review_${selectedPlan}&slug=${business.slug}&amount=${selectedPlan === "monthly" ? 30 : 249}`}
